...
os.system("iptables -I FORWARD 1 -d 192.168.2.2 -p TCP --sport 80 -i enp3s0 -j NFQUEUE 2")
...
def my_second_callback(payload):
    ...
    # SYN packet
    if pkt.src == ip_dest and pkt.sport == 80 and (pkt[TCP].flags & 0x2 == 0x2) and not(pkt[TCP].flags & 0x12 == 0x12):
        if True:
