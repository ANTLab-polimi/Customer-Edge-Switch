...
apt-get install -qq -y --no-install-recommends --fix-missing  ca-certificates curl emacs git iproute2 lubuntu-desktop net-tools
apt-get install -qq -y --no-install-recommends --fix-missing  python3 python3-pip tcpdump unzip valgrind vim wget
apt-get install -qq -y --no-install-recommends --fix-missing  xcscope-el xterm p4lang-p4c p4lang-bmv2 p4lang-pi
